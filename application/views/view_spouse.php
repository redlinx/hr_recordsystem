<div class="body">
    ...
    {
    ?>
        <?php echo '<a href="'.base_url().'index.php/update_form/spouse/'.$this->session->userdata('emp_id').'">'; ?> <button type="mysubmit" class="btn btn-primary"> <span class="glyphicon glyphicon-pencil"></span></button> </a>
    <?php
    }
    else
    {
    ?>
        <?php echo '<a href="'.base_url().'index.php/forms/spouse">'; ?> <button type="mysubmit" class="btn btn-primary"> Add </button> </a>
    <?php
    }
    ?>
    <br/><br/>
