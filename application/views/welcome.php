...
<table width="600" border="0" align="center">
    ...
    <tr>
        <td>
            ...
            <input id="reg" name="New" type="button" value="Login" onclick="window.location='index.php/home/login'" />
            <input id="reg" name="New" type="button" value="Register" onclick="window.location='index.php/home/add'" />
            <input id="reg" name="New" type="button" value="Faculty" onclick="window.location='index.php/home/management'" />
        </td>
    </tr>
    <tr>
        <td>
