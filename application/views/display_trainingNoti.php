    ...
    <table width="450" align="left" class="table table-striped sortable">
        ...
        <?php
            for($x=0;$x<count($page_view_content);$x++)
            {
                    ...
                    echo '<td><a href="'.base_url().'index.php/display_notification/verify_training/'.$page_view_content[$x]['training_id'].'"><button class="btn btn-success btn-sm">Verify</button></a></td>';
                    echo '</tr>';
            }
        ?>  
    </table>
