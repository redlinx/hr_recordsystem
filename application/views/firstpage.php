...
<center>
    <form>
        ...
        <legend><b>Personal Information of Faculty:</b></legend>
        ...
        Last name: &nbsp&nbsp&nbsp <input type="text" name="Lname"><br />
                ...
                Place of Birth:&nbsp<input type="text" name="pday"><br />
                City Address:<input type="text" name="address"><br />
                Province Address:<input type="text" name="paddress"><br />
                ...
                Civil Status: <select>
                    ...
                    <option value="hof">Head of the Family</option>
                    <option value="ls">Legally Separated</option>
                    <option value="ws">Working Spouse</option>
                    <option value="nws">Non-Working Spouse</option>
