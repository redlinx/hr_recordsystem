<div class="body">
    ...
    <?php
        for($x=0;$x<count($page_view_content);$x++)
        {
            ...
            echo '<td><a href="'.base_url().'index.php/update_form/skill/'.$page_view_content[$x]['skill_id'].'"><button class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-pencil"></span></button></a></td>';
            echo '</tr>';
        }
    ?>
    </table>
